...
from .views import (
    ...
    field_incident_updates_stream, field_incident_reset
)
...
urlpatterns = [
    ...
    path("mock/incidents/<int:incident_id>/severity/",
         mock_incident_severity, name="mock_incident_severity"),
    ...
    path("field-incident/reset/", field_incident_reset,
         name="field-incident-reset"),
]
